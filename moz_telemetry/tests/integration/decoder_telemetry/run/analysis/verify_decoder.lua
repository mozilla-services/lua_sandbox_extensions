...
--[[
# Verifies the test data for moz_ingest telemetry decoder
--]]
...
local messages = {
    {Logger = "telemetry", Type = "telemetry", Hostname = "example.com", Fields = {
            ["payload.childPayloads"] = '[{"chromeHangs":{"annotations":[],"durations":[],"firefoxUptime":[],"memoryMap":[],"stacks":[],"systemUptime":[]},"log":[],"simpleMeasurements":{"firstLoadURI":2028,"js":{"customIter":0,"setProto":19},"main":0,"maximalNumberOfConcurrentThreads":36,"startupInterrupted":0,"totalTime":44178,"uptime":736},"threadHangStats":[{"activity":{"bucket_count":33,"histogram_type":0,"log_sum":0,"log_sum_squares":0,"range":[1,0],"sum":0,"values":{}},"hangs":[],"name":""},{"activity":{"bucket_count":33,"histogram_type":0,"log_sum":0,"log_sum_squares":0,"range":[1,0],"sum":0,"values":{"0":0,"1":15,"3":0}},"hangs":[],"name":"ImageBridgeChild"},{"activity":{"bucket_count":33,"histogram_type":0,"log_sum":0,"log_sum_squares":0,"range":[1,0],"sum":0,"values":{"0":0,"1":13,"3":0}},"hangs":[],"name":"ProcessHangMonitor"}],"ver":4,"webrtc":{"IceCandidatesStats":{"loop":{},"webrtc":{}}}}]',
