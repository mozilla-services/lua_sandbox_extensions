...
set(PACKAGE_DEPENDENCIES "luasandbox (>= 0.24)")
if(PACKAGE_DEPENDENCIES_EXTRA)
    set(PACKAGE_DEPENDENCIES "${PACKAGE_DEPENDENCIES},${PACKAGE_DEPENDENCIES_EXTRA}")
endif()
set(CPACK_DEBIAN_PACKAGE_DEPENDS ${PACKAGE_DEPENDENCIES})
string(REGEX REPLACE "[()]" ""  CPACK_RPM_PACKAGE_REQUIRES ${PACKAGE_DEPENDENCIES})

set(SB_DIR ${CMAKE_CURRENT_SOURCE_DIR}/sandboxes)
if(IS_DIRECTORY ${SB_DIR})
   install(DIRECTORY ${SB_DIR}/ DESTINATION ${INSTALL_SANDBOX_PATH})
endif()

set(MODULE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/modules)
if(IS_DIRECTORY ${MODULE_DIR})
    install(DIRECTORY ${MODULE_DIR}/ DESTINATION ${INSTALL_MODULE_PATH})
endif()
...
if(LUA51) # build against the installed Lua 5.1
    ...
    if(INTEGRATION_TEST)
        add_test(NAME ${MODULE_NAME}_test COMMAND ${LUA} test.lua CONFIGURATIONS integration)
    else()
    ...
    if(INTEGRATION_TEST)
        add_test(NAME ${MODULE_NAME}_test_sandbox COMMAND ${MODULE_NAME}_test_sandbox CONFIGURATIONS integration)
    else()
