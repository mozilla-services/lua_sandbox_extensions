...
function decode(data, dh, mutable)
    ...
    if type(th) == "table" then
        ...
        local key = np .. "_" ..  base_msg.Fields["symbol"] .. "_" .. base_msg.Fields["groupSymbol"]
        g = schemas_map[key]
    end
