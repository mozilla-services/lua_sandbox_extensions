...
local results = {"autoland", "mozilla-release", "mozilla-central", "mozilla-esr68", "try", "autoland", "mozilla-central", "try", "mozilla-beta", "android-components", "autoland", "mozilla-central", "try", "autoland"}
